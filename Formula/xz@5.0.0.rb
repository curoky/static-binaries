...
class XzAT500 < Formula
  desc "General-purpose data compression with high compression ratio"
  homepage "https://tukaani.org/xz/"
  version "5.0.0"
  url "https://downloads.sourceforge.net/project/lzmautils/xz-5.0.0.tar.gz"
  license "GPL-2.0"
  ...
  test do
    ...
    assert_match "liblzma 5.0.0", shell_output("#{bin}/xz --version").strip
