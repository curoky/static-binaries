...
class XzAT522 < Formula
  desc "General-purpose data compression with high compression ratio"
  homepage "https://tukaani.org/xz/"
  version "5.2.2"
  url "https://downloads.sourceforge.net/project/lzmautils/xz-5.2.2.tar.gz"
  license "GPL-2.0"
  ...
  test do
    ...
    assert_match "liblzma 5.2.2", shell_output("#{bin}/xz --version").strip
